...
import { HashIcon, LockIcon, UsersIcon, VideoIcon } from "lucide-react";
import { useState } from "react";
import { PinIcon, useChannelStateContext } from "stream-chat-react";
...
const CustomChannelHeader = () => {
  ...
  return (
    <div className="h-14 border-b border-gray-200 flex items-center px-4 justify-between bg-white">
      ...
      {
        showMembers && (
            <MembersModal members={Object.values(channel.state.members)}
      ...
      {showInvite && <InviteModal
       channel={channel} onClose={() => setShowInvite(false)}/>}
    </div>
  );
};
