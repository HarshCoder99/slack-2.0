...
const UsersList = ({ activeChannel }) => {
  ...
  // behaviour: during these 5 minutes , React Query WON'T refetch the data automatically
      ...
      {users.map((user) => {
        ...
        return (
          <button
            ...
            className={`str-chat__channel-preview-messenger ${isActive && "!bg-black/20 !hover:bg-black/20 border-l-8 border-purple-500 shadow-lg"}`}
          >
